...
public interface MenuDao {
	...
	//根据父亲id获取所有儿子
	public List<MenuEntity> findlistbypid_memId(@Param("id")Integer id,@Param("memId")Integer memId);

	public void deleteByAdminId(Integer adminId);

	public int insert(MemMenuEntity memMenu);

	public MemMenuEntity selectByMenuId_MemId(@Param("menuId")Integer menuId,@Param("memId")Integer memId);
