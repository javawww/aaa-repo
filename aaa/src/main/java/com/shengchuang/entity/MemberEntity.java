...
public class MemberEntity implements Serializable{
	...
	private java.lang.Integer   			jhState; //激活状态  0未激活  1已激活
	private java.lang.Integer   			gjLevel; //管家等级  0普通管家  1超级管家
	...
	private java.lang.Integer   			djState; //冻结状态  0冻结  1解冻
	private java.lang.Integer   			roleState; //角色类型  0普通会员  1超级管理员
	...
	private java.lang.Integer   			bankType; //银行卡类型  0中国工商银行、1中国建设银行、2中国银行、3中国农业银行、4交通银行
	...
	private java.lang.Integer 				ztAmounts;//直推数量  即直接推荐人的数量
	private java.lang.Integer             	teamAmounts;//团队数量 即直接推荐和间接推荐和本身数量和
	private java.lang.Integer 				protectQuest;//密保问题  0最喜欢看的电影是什么? 1曾经去过最远的地方是? 2父亲的生日日期是多少号?
