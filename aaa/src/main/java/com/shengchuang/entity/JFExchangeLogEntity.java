...
/**
 * 积分兑换记录信息   玩家互转  积分转换  等比例1:1进行转换
 * @author Administrator
 *
 */
@SuppressWarnings("serial")
public class JFExchangeLogEntity implements Serializable{
	...
	private java.lang.Integer 				zhhFromType;//转换币种类型  即源类型:5种子积分 0动态钱包 2静态解冻钱包##############
	private java.lang.Integer 				zhhToType;//兑换币种类型 即目标类型:5种子积分 3神童日俸 4管家月俸 6激活积分##############
