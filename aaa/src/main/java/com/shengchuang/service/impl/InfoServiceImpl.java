...
public class InfoServiceImpl implements InfoService {
	...
	public List<Map> findCommon(Integer page, String infType) {
		...
		map.put("limit", 20); 
		map.put("infType", infType);
		return commonDao.findCommon(map);
	}
/*	@Override
	public List<InformationEntity> findCommon(Integer page, String infType) {
		Map map = new HashMap();
		map.put("start", 20*(page-1));
		map.put("limit", 20); 
		map.put("infType", infType);
...
*/	
	...
	public List<Map> findCommonByRolestate(int page, String djrxm, String types, String prostate, Integer uid) {
		...
		map.put("prostate", prostate);
		map.put("uid", uid);
		List<Map> list = commonDao.findCommonByRolestate(map);
	...
	public int findCommonCountByRolestate(String djrxm, String types, String prostate, Integer uid) {
		...
		map.put("prostate", prostate);
		map.put("uid", uid);
		return commonDao.findCommonCountByRolestate(map);
	}
	...
	public List<InformationEntity> findAllInfo() {
		return commonDao.findAllInfo();
	}

	@Override
	public InformationEntity findInformationEntityById(int id) {
		return commonDao.findInformationEntityById(id);
	}
}
